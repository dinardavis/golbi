    ...
    <Section>
      ...
      <div className="pricing-content">
        <div className="site-feature-payment-copy-container">
          ...
          <p className="site-feature-payment-copy">Simple 50/50 billing<br></br>50% to start, then the remaining 50% at launch</p>
        </div>
        ...
        <div className="site-feature-header">
          ...
          <div className="site-feature-col site-name-container left">
            <h3 className="site-header-name">Single-Page<br/><span>$1,595</span></h3>
          </div>
          <div className="site-feature-col site-name-container">
            <h3 className="site-header-name">Multi-Page<br/><span>$3,995</span></h3>
          </div>
        </div>
        ...
        <div className="site-feature-row">
          ...
          <div className="site-feature-col site-feature-desc">Perfect for <span >coaches, consultants, and solopreneurs</span> that need a professional online presence.</div>
          <div className="site-feature-col site-feature-desc">Designed for businesses that need more space to clearly communicate their services, credibility, and value.</div>
        </div>
  ...
  {/* Custom Plan Inquiry Card */}
        <div className="pricing-option-3">
          <div className="pricing-cta-copy">
            ...
            Don't see exactly the package or services you need?
            </p>
